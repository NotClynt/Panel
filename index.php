...
<img src="https://media.discordapp.net/attachments/919533264119677018/927264353504362496/PicsArt_01-02-07.16.51.png" alt="" class="img-fluid"> <div class="overlay-picture">
...
<div class="row">
<div class="col-4">
<h2>Virty <span style="color: var(--primary); font-weight:700; font-size: .9rem;">V<?php Util::display($cheat->getCheatData()->version); ?></span></h2> </div>
<div class="col-8 text-right">
<a href="download.php" class="button primary outline rounded-circle low-padding low-weight medium-size">Download</a> </div>
</div>
<div class="box d-flex justify-content-center mb-0">
<span><?php echo $motd ?></span> </div>
</div>
...
<div class="row">
<div class="col-md-7">
<div class="d-flex align-items-center"><img src='https://cdn.discordapp.com/avatars/882166477157986384/a_bd85d318261a83ce725580986dc9fc6d.gif?size=2048' alt='Profile picture' class='img-fluid'><div class="user">
<h3>Clynt</h3>
<span>Admin</span>
</div>
</div>
...
<div class="box">
<ul style="padding-left: 0; margin-bottom: 0;"><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> New Design</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> More Security</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=fixed>fixed</span> API</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=fixed>fixed</span> HWID Reset</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=fixed>fixed</span> Password change</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=fixed>fixed</span> Discord link</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"></ul>
</div>
</div>
<div class="changelogs box mb-3">
<div class="title">
...
<div class="box">
<ul style="padding-left: 0; margin-bottom: 0;"><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> Cloud Themes</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> Cloud Scripts</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span>  Moderation Commands </li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> NSFW Commands</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> Func Commands</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> Radi Commands</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> Hack Commands</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> Spam Commands</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=added>added</span> Text commands</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=fixed>fixed</span> API</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=fixed>fixed</span> Colors</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=fixed>fixed</span> Notifications</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"><span class=fixed>fixed</span> Updater</li><li style="list-style-type: none; margin-left: 0; margin-top: .4rem; margin-bottom:.4rem"></ul>
</div>
</div>
<div class="changelogs box mb-3">
<div class="title">
